...
public class HerbalismCommonSystem extends BaseComponentSystem {
    ...
    public void preBegin() {
        ...
        herbEffectRegistry.registerHerbEffect(1f,
                new AlterationEffectWrapperHerbEffect(new WalkSpeedAlterationEffect(context), 1f, 1f));
        herbEffectRegistry.registerHerbEffect(1f,
                new AlterationEffectWrapperHerbEffect(new SwimSpeedAlterationEffect(context), 1f, 1f));
        herbEffectRegistry.registerHerbEffect(1f,
                new AlterationEffectWrapperHerbEffect(new RegenerationAlterationEffect(context), 1f, 100f));
        herbEffectRegistry.registerHerbEffect(1f,
                new AlterationEffectWrapperHerbEffect(new WaterBreathingAlterationEffect(context), 1f, 1f));
        herbEffectRegistry.registerHerbEffect(1f,
                new AlterationEffectWrapperHerbEffect(new JumpSpeedAlterationEffect(context), 1f, 1f));
        herbEffectRegistry.registerHerbEffect(1f,
                new AlterationEffectWrapperHerbEffect(new MultiJumpAlterationEffect(context), 1f, 1f));
                ...
                new Function<String, TextureRegionAsset>() {
                    ...
                    public TextureRegionAsset apply(String input) {
                        ...
                        HerbHueComponent herbHue =
                                prefabManager.getPrefab("WoodAndStone:HerbHue" + type).getComponent(HerbHueComponent.class);
                        ...
                        return Assets.getTextureRegion(HerbIconAssetResolver.getHerbUri("WoodAndStone:Herb" + type,
                                hueValues)).get();
                    }
                });
