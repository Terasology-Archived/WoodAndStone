...
public class WoodAndStoneJournalIntegration implements ComponentSystem {
    ...
    public void initialise() {
        ...
        chapterHandler.registerJournalEntry("2", "Excellent! I got a hammer, I should be able to sharpen one of the stones " +
        ...
        chapterHandler.registerJournalEntry("3", "Ouch! That thing is sharp! I should watch out when handling it. " +
                "Now I should be able to cut some of the trees and get Wood Logs.");

        chapterHandler.registerJournalEntry("4", "These are big, there is no way I could handle them in my hands. " +
        ...
        chapterHandler.registerJournalEntry("5", "Now I can work on the logs (to open the interface, press 'E' while pointing " +
        ...
        chapterHandler.registerJournalEntry("6", "Finally I can make something more useful than just planks. " +
        ...
        chapterHandler.registerJournalEntry("7", "Now! I should be able to sharpen a stone and use it to attach another " +
