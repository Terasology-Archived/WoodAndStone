...
public class FarmingAndCookingJournalIntegration extends BaseComponentSystem {
    private final String chapterId = "FarmingAndCooking";
    private final Multimap<String, String> dependencyMap = HashMultimap.create();
    @In
    ...
    public void preBegin() {
        ...
        chapterHandler.registerJournalEntry("introduction",
                Arrays.asList(
                        ...
                        createTextParagraph("This part of your journal will guide you through farming and cooking " +
                                "activities required " +
        ...
        chapterHandler.registerJournalEntry("quern",
                Arrays.asList(
                        ...
                        createTextParagraph("Quern, also known as a hand mill, allows you to grind various " +
                                "substances, including grain. " +
        ...
        chapterHandler.registerJournalEntry("cookingStation",
                Arrays.asList(
                        ...
                        createTextParagraph("Cooking Station allows you to prepare food. To built it, you need to " +
                                "create two Brick Blocks " +
                                "at an upgraded Stone Station, and also two Cobble Stone Slabs. Once you have these, " +
                                "put the Brick Blocks next " +
                                "to each other, place the Slabs on top of them and right-click the structure while " +
                                "holding a hammer in hand " +
                                "to finish off the process.<l><l>Cooking Station recipes might require water and heat" +
                                " to operate. You can store " +
                                "some water in the container provided by the station user interface. You might want " +
                                "to use bucket to fill the " +
                                "container.<l><l>Some recipes might also require heat. Heat is produced by burning " +
        ...
        chapterHandler.registerJournalEntry("corn",
                Arrays.asList(
                        ...
                        createTextParagraph("Corn, also known as maize, is a grain plant. As with any plant fruits " +
                                "gathered, you can use knife to " +
                                "change it into a Corn Sapling, then you can plant it, please keep in mind, that Corn" +
                                " grows best in warm and humid " +
                                "environment.<l><l>You can process Corn for food in two ways, either cook it in water" +
                                " directly at the Cooking " +
                                "Station, or use Quern to grind it into a Corn Flour and cook is with salt to produce" +
                                " bread.")
                ));
        ...
        chapterHandler.registerJournalEntry("rice",
                Arrays.asList(
                        ...
                        createTextParagraph("Rice is a grain plant. As with any plants you gather, you can use knife " +
                                "to change it into a Rice Sapling, " +
                                "then you can plant it, please keep in mind, that Rice requires very humid " +
                                "environment.<l><l>To prepare rice for eating, " +
                                "first you need to grind it in a quern to get White Rice. Once you get it, you can " +
                                "cook it at a Cooking Station with " +
