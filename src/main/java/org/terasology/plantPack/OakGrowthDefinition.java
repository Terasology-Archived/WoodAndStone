...
public class OakGrowthDefinition implements PlantGrowthDefinition {
    ...
    public OakGrowthDefinition() {
        ...
        String oakSapling = "WoodAndStone:OakSapling";
        String oakSaplingGenerated = "WoodAndStone:OakSaplingGenerated";
        String greenLeaf = "WoodAndStone:OakLeaf";
        String oakTrunk = "WoodAndStone:OakTrunk";
        String oakBranch = "WoodAndStone:OakBranch";
